...
namespace SineahBot.Tools
{
    public static class ClassProgressionManager
    {
        ...
        private static Dictionary<CharacterClass, ClassProgression> classProgression = new Dictionary<CharacterClass, ClassProgression>()
        {
            // physical path
            ...
            // melee path
            { CharacterClass.Guard, new ClassProgression(CharacterClass.Guard, 30, 13).RegisterSubclass(CharacterClass.Footman, 6) },
            { CharacterClass.Footman, new ClassProgression(CharacterClass.Footman, 40, 16).RegisterSubclass(CharacterClass.Knight, 9) },
            { CharacterClass.Knight, new ClassProgression(CharacterClass.Knight, 50, 19) },
            // range path
            { CharacterClass.Ranger, new ClassProgression(CharacterClass.Ranger, 25, 12).RegisterSubclass(CharacterClass.Archer, 6) },
            { CharacterClass.Archer, new ClassProgression(CharacterClass.Archer, 30, 14).RegisterSubclass(CharacterClass.Sharpshooter, 9) },
            ...
            // faith path
            { CharacterClass.Abbot, new ClassProgression(CharacterClass.Abbot, 20, 10, 15, 3).RegisterSubclass(CharacterClass.Prelate, 2) },
            { CharacterClass.Prelate, new ClassProgression(CharacterClass.Prelate, 25, 12, 15, 3).RegisterSubclass(CharacterClass.Bishop, 2) },
            { CharacterClass.Bishop, new ClassProgression(CharacterClass.Bishop, 30, 14, 15, 3) },
            // magic path
            { CharacterClass.Enchanter, new ClassProgression(CharacterClass.Enchanter, 20, 10, 20, 4).RegisterSubclass(CharacterClass.Mage, 2) },
            { CharacterClass.Mage, new ClassProgression(CharacterClass.Mage, 24, 11, 20, 4).RegisterSubclass(CharacterClass.Wizard, 2) },
        ...
        {
            var progression = classProgression[character.characterClass];
